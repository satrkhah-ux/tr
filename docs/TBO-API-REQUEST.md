...
| | |
|---|---|
| أُرسلت | الثلاثاء ٢٨ يوليو ٢٠٢٦، ١٣:٠٠ — من `it@traveliun.com` |
| إلى | `partners@tboholidays.com` · نسخة `support@tboholidays.com` و`info@traveliun.com` |
| رقم التذكرة | **41508641** |
| الردّ حتى الآن | إشعار استلام آلي بعد دقيقتين. لا ردّ بشري. |
| متابعة الحالة | `support@tbo.com` مع ذكر رقم التذكرة |

جهات التصعيد (بورتال الفنادق · **API الفنادق** · الطيران · التصعيد الثاني) وردت في إشعار الاستلام
ومحفوظة في صندوق `it@traveliun.com` — لم تُنسخ هنا لأن هذا المستودع **عام**، وهي بيانات أفراد.
استخدم منها جهة **API (Hotel)** إن لزم التصعيد، فهي المطابقة لطلبنا.

**المتوقّع في ردّهم:** تأكيد الحساب بالسجل التجاري، ثم بيانات تجريبية مع **رابط البيئة التجريبية** —
ذاك الرابط شرط لتشغيل وضع «تجريبي» في النظام (انظر آخر الملف).
